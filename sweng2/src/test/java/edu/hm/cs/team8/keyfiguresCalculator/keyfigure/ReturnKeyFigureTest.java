...
public class ReturnKeyFigureTest {
	...
	public void setUp() throws ClassNotFoundException {
		...
		performance = new PerformanceKeyFigure();
	...
	public void test() {
		...
		KeyFigureResult result = performance.calculate(KeyFigures.PERFORMANCE,
				entries);
		
		Assert.assertEquals(result.getValue(), new Double(45.5));
