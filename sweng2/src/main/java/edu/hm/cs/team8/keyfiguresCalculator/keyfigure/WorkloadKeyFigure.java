...
public class WorkloadKeyFigure implements IKeyFigure {
	...
	public KeyFigureResult calculate(KeyFigures keyfigure, final Set<TimeTrackingEntry> timeTrackings) {
		...
		final double performance = (double) new PerformanceKeyFigure().calculate(keyfigure, timeTrackings).getValue();

		final double billablePerformance = (double) new BillablePerformanceKeyFigure().calculate(keyfigure,
